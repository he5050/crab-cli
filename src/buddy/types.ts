...
export type CompanionStat = "DEBUGGING" | "PATIENCE" | "CHAOS" | "WISDOM" | "SNARK";
...
export const COMPANION_STATS: CompanionStat[] = ["DEBUGGING", "PATIENCE", "CHAOS", "WISDOM", "SNARK"];
